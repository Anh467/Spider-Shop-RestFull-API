...
func (s *sqlserverStore) SigninUser(c context.Context, userCredential entities.UserCredential) entities.UserJWTModel {
	// declare
	var userJWTModel entities.UserJWTModel
	var err error
	// check user credentials
	if err := s.aptx.GormDB.Where(userCredential).
